...
export const DEFAULT_STRATEGIES: Strategy[] = [
  {
    ...
    rules: [
      ...
      { id: "vgd-s1", label: "Trend Healthy", category: "setup", metric: "priceAboveSma200", dateRange: "1D", operator: "is", value: "TRUE", weightPct: 18, enabled: true, myPlan: "Example: No adds until price reclaims the 200-day." },
      { id: "vgd-s2", label: "Intermediate Trend Healthy", category: "setup", metric: "priceAboveSma50", dateRange: "1D", operator: "is", value: "TRUE", weightPct: 16, enabled: true, myPlan: "Example: Wait for a reclaim of the 50-day before buying." },
      { id: "vgd-s3", label: "Entry Not Overbought", category: "setup", metric: "rsi", dateRange: "1D", operator: "<", value: 70, weightPct: 13, enabled: true, myPlan: "Example: Let RSI cool before adding size." },
      ...
      { id: "vgd-s6", label: "Buyers Present", category: "setup", metric: "relativeVolume", dateRange: "1D", operator: ">=", value: 0.8, weightPct: 8, enabled: true, myPlan: "Example: Wait for volume confirmation before adding." },
      { id: "vgd-s7", label: "Price Above Short-Term Trend", category: "setup", metric: "priceAboveSma20", dateRange: "1D", operator: "is", value: "TRUE", weightPct: 9, enabled: true, myPlan: "Example: No adds until price reclaims the 20-day trend." },
  ...
  },
  {
    ...
    rules: [
      ...
      { id: "aih-s1", label: "Trend Healthy", category: "setup", metric: "priceAboveSma200", dateRange: "1D", operator: "is", value: "TRUE", weightPct: 25, enabled: true, myPlan: "Example: No adds until price reclaims the 200-day." },
      { id: "aih-s2", label: "Intermediate Trend Healthy", category: "setup", metric: "priceAboveSma50", dateRange: "1D", operator: "is", value: "TRUE", weightPct: 20, enabled: true, myPlan: "Example: Wait for a reclaim of the 50-day before buying." },
      { id: "aih-s3", label: "Momentum Not Exhausted", category: "setup", metric: "rsi", dateRange: "1D", operator: "<", value: 75, weightPct: 20, enabled: true, myPlan: "Example: Let RSI cool before adding size." },
      ...
      { id: "aih-s5", label: "Buyers Present", category: "setup", metric: "relativeVolume", dateRange: "1D", operator: ">=", value: 0.8, weightPct: 15, enabled: true, myPlan: "Example: Wait for volume confirmation before adding." },
      // ---- Risk Rules (5 chips) ----
...
export const CHIP_LIBRARY_SEED: RuleChip[] = [
  ...
  { id: "lib-uptrend", label: "Above 50-day trend", category: "setup", metric: "priceAboveSma50", dateRange: "1D", operator: "is", value: "TRUE", weightPct: 25, enabled: true, myPlan: "Example: No adds until price reclaims the 50-day." },
  { id: "lib-rsiband", label: "Healthy momentum (RSI 45–70)", category: "setup", metric: "rsi", dateRange: "1D", operator: "between", value: [45, 70], weightPct: 25, enabled: true, myPlan: "Example: Let RSI return to the healthy band before adding." },
